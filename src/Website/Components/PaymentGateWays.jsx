import Portrait from "../../assets/payments.jpg";
import { Users, Zap,Shield,TimerIcon, Car } from "lucide-react";
...
function PaymentGateways() {   
	return (<main className="">
	   ...
	   <div className="container mx-auto flex flex-col lg:flex-row py-8 sm:py-12 lg:py-16 px-2 gap-6 lg:gap-20 2xl:gap-24 ">
						...
						<div  className="w-full order-first lg:order-last  relative lg:w-1/2 p-4 bg-light border border-dark/10 flex items-center justify-center   rounded-2xl">
						...
						<div className="flex flex-col w-full lg:w-1/2 space-y-6">
							<div className="space-y-4">
								<h1 className="text-secondary font-bold text-xl sm:text-3xl lg:text-4xl  leading-tight">
								   <span className="text-dark">Payment Gateways</span>  Intergration
								</h1>
								...
								<div className="flex flex-col text-sm lg:text-lg gap-2">
									...
									<div className="flex gap-3 items-center ">
										<div className="p-2 bg-  rounded-full">
											<SiPaypal className="w-5 h-5 sm:w-6 sm:h-6 text-blue-700" />
										</div>
										<div>
											<span className="font-semibold  text-dark">
											  Paypal payment and transactions Intergration
											</span>
									...
									<div className="flex items-center gap-3 ">
										<div className="bg-blue-500  p-2 rounded-xl">
											<SiStripe className="w-5 h-5 sm:w-6 sm:h-6 text-white"/>
										</div>
										<div>
											<span className="font-semibold  text-dark">
												Stripe payments and transactions intergration
											</span>
									...
									<div className="flex items-center gap-3 ">
										<div className="p-2 rounded-full">
											<SiVisa className="w-5 h-5 sm:w-6 sm:h-6 text-blue-500" />
										</div>
										<div>
											<span className="font-semibold  text-dark">
											  Card payments Intergrations eg.Visa,MasterCard,Equity,KCB etc
											</span>
