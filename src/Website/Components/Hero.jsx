    ...
    <section className="min-h-screen 2xl:min-h-full  relative 2xl:py-20 bg-primary bg-homeBg aspect-auto bg-center  bg-cover py-2">
      ...
      <div className="relative z-10 pt-16">
        <div className="container mx-auto px-3 lg:px-16">
          <div className="flex flex-col lg:flex-row items-center justify-between lg:mb-6">
            
            {/* Left Content */}
            <div className="flex-1 gap-3 lg:pr-12 mb-12">
              ...
              <div className="border border-secondary p-2 2xl:p-4 flex items-center lg:mb-4 rounded-xl">
                <h2 className="text-lg 2xl:text-xl font-bold text-secondary">
                  Services: 
        ...
        <div className="container mx-auto px-2 md:px-10">
          <div id="stats" className="md:flex grid grid-cols-2 items-center justify-center md:gap-8 gap-3"> 
