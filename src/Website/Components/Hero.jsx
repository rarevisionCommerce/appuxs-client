        ...
        <div className="flex-1 lg:pr-12 mb-12">
          ...
          <div className="flex justify-center lg:justify-start gap-4">
            <Link 
              ...
              smooth={true} 
              duration={1000} 
              className="bg-secondary hover:bg-secondary transition-colors duration-300 px-8 py-2 text-primary font-semibold rounded-lg text-center cursor-pointer shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              View Projects
            </Link>
            <Link 
              ...
              smooth={true} 
              duration={1000}
              className="bg-transparent border-2 border-secondary hover:bg-secondary hover:text-primary transition-all duration-300 px-8 py-2 text-secondary font-semibold rounded-lg text-center cursor-pointer shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              Get Estimate
            </Link>
          </div>
