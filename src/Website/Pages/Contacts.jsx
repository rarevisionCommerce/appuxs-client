        ...
        <>
            ...
            <div className='min-h-screen  '>
                ...
                <header className="relative py-16 bg-gradient-to-br from-primary via-dark to-primary overflow-hidden">
                    ...
                    {/* Main Content */}
                    <div className="relative z-10 flex flex-col justify-center gap-6 items-center px-4 pt-8">
                        ...
                        <div className="mt-3 bg-secondary/20 backdrop-blur-sm border border-secondary/30 hover:bg-secondary/30 transition-all duration-300 rounded-full px-6 py-3 text-center">                     
                            ...
                            <div className="text-secondary gap-2 inline-flex items-center"> <div className="bg-secondary rounded-full p-1"></div> 24/7 support</div>
